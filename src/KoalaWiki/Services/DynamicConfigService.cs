...
public class DynamicConfigService
{
    ...
    private Dictionary<string, string[]> GetEnvironmentVariableMappings()
    {
        return new Dictionary<string, string[]>
        {
            ...
            { "ChatModelEndpoint", new[] { "CHAT_MODEL_ENDPOINT", "ChatModelEndpoint" } },
            { "ChatModelApiKey", new[] { "CHAT_MODEL_API_KEY", "ChatModelApiKey" } },
            { "ChatModelProvider", new[] { "CHAT_MODEL_PROVIDER", "ChatModelProvider" } },
            { "AnalysisModelEndpoint", new[] { "ANALYSIS_MODEL_ENDPOINT", "AnalysisModelEndpoint" } },
            { "AnalysisModelApiKey", new[] { "ANALYSIS_MODEL_API_KEY", "AnalysisModelApiKey" } },
            { "AnalysisModelProvider", new[] { "ANALYSIS_MODEL_PROVIDER", "AnalysisModelProvider" } },
            { "DeepResearchModelEndpoint", new[] { "DEEP_RESEARCH_MODEL_ENDPOINT", "DeepResearchModelEndpoint" } },
            { "DeepResearchModelApiKey", new[] { "DEEP_RESEARCH_MODEL_API_KEY", "DeepResearchModelApiKey" } },
            { "DeepResearchModelProvider", new[] { "DEEP_RESEARCH_MODEL_PROVIDER", "DeepResearchModelProvider" } },
    ...
    private List<SystemSetting> GetDefaultSettings()
    {
        return new List<SystemSetting>
        {
            ...
            new() { Key = "ChatModelEndpoint", Group = "OpenAI", ValueType = "string", Description = "聊天模型独立API地址", IsSensitive = false, RequiresRestart = true, DefaultValue = "", Order = 50 },
            new() { Key = "ChatModelApiKey", Group = "OpenAI", ValueType = "string", Description = "聊天模型独立API密钥", IsSensitive = true, RequiresRestart = true, DefaultValue = "", Order = 51 },
            new() { Key = "ChatModelProvider", Group = "OpenAI", ValueType = "string", Description = "聊天模型独立提供商", IsSensitive = false, RequiresRestart = true, DefaultValue = "", Order = 52 },
            new() { Key = "AnalysisModelEndpoint", Group = "OpenAI", ValueType = "string", Description = "分析模型独立API地址", IsSensitive = false, RequiresRestart = true, DefaultValue = "", Order = 53 },
            new() { Key = "AnalysisModelApiKey", Group = "OpenAI", ValueType = "string", Description = "分析模型独立API密钥", IsSensitive = true, RequiresRestart = true, DefaultValue = "", Order = 54 },
            new() { Key = "AnalysisModelProvider", Group = "OpenAI", ValueType = "string", Description = "分析模型独立提供商", IsSensitive = false, RequiresRestart = true, DefaultValue = "", Order = 55 },
            new() { Key = "DeepResearchModelEndpoint", Group = "OpenAI", ValueType = "string", Description = "深度研究模型独立API地址", IsSensitive = false, RequiresRestart = true, DefaultValue = "", Order = 56 },
            new() { Key = "DeepResearchModelApiKey", Group = "OpenAI", ValueType = "string", Description = "深度研究模型独立API密钥", IsSensitive = true, RequiresRestart = true, DefaultValue = "", Order = 57 },
            new() { Key = "DeepResearchModelProvider", Group = "OpenAI", ValueType = "string", Description = "深度研究模型独立提供商", IsSensitive = false, RequiresRestart = true, DefaultValue = "", Order = 58 },
